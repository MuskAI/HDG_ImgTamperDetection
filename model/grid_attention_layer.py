...
if __name__ == '__main__':
    ...
    for mode in mode_list:
        ...
        img = Variable(torch.rand(2, 16, 20, 20))
        gat = Variable(torch.rand(2, 64, 10, 10))
        # net = GridAttentionBlock3D(in_channels=16, inter_channels=16, gating_channels=64, mode=mode, sub_sample_factor=(2,2,2))
        net2 = GridAttentionBlock2D(in_channels=16,inter_channels=16,gating_channels=64,mode=mode,sub_sample_factor=(2,2))
        out, sigma = net2(img, gat)
        print(out.size())