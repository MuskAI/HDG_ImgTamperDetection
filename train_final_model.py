...
parser.add_argument('--model_save_dir', type=str, help='model_save_dir',
                    default='save_model/final_model_finetune')
# =============== optimizer
...
parser.add_argument('--maxepoch', default=200, type=int, metavar='N',
...
parser.add_argument('--gpu', default='0', type=str,
                    help='GPU ID')
#####################resume##########################
parser.add_argument('--resume', default='/home/liu/haoran/HDG_ImgTamperDetection/save_model/final_model_finetune/0404-88-0.101020-[f10.741788-precision0.661334-acc0.956696-recall0.859661]-[f10.440777-precision0.292013-acc0.952597-recall0.927801]-[f10.440777-precision0.292013-acc0.952597-recall0.927801].pth', type=str, metavar='PATH',
...
output_name_file_name = '0418-%d-%f-[f1%f-precision%f-acc%f-recall%f]-' \
