...
parser.add_argument('--model_save_dir', type=str, help='model_save_dir',
                    default='../save_model/0108_naive_unet_area_coco_sp_cm')
# =============== optimizer
...
# tensorboard 使用
writer = SummaryWriter('../runs/' + '0108_tensorboard')
output_name_file_name = '0108_naive_unet_area_checkpoint-%d-%f-f1%f-precision%f-acc%f-recall%f.pth'
""""""""""""""""""""""""""""""
"    ↑↑↑↑需要修改的参数↑↑↑↑     "
""""""""""""""""""""""""""""""
