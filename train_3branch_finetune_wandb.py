...
parser.add_argument('--batch_size', default=50, type=int, metavar='BT',
                    help='batch size')
parser.add_argument('--model_save_dir', type=str, help='model_save_dir',
                    default='save_model/04_3branch_area_band')
# =============== optimizer
...
parser.add_argument('--gpu', default='0', type=str,
                    help='GPU ID')
#####################resume##########################
parser.add_argument('--resume', default='/home/liu/haoran/HDG_ImgTamperDetection/save_model/0331_3branch_area/0303_3branch-40-0.023795-[f10.806111-precision0.718707-acc0.969270-recall0.921069]-[f10.084216-precision0.046085-acc0.786715-recall0.493497]-[f10.084216-precision0.046085-acc0.786715-recall0.493497].pth', type=str, metavar='PATH',
